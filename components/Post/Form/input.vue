    ...
    <div>
        <div class="flex items-center flex-shrink-0 p-4 pb-0">
            ...
            <div class="w-full p-2">
                <textarea v-model="text" class="w-full h-10 text-lg text-gray-600 placeholder:text-gray-400 bg-transparent border-0 focus:ring-0" placeholder="What's happening?"></textarea>
            </div>
        ...
        <div class="flex p-2 pl-14">
            <div class="flex w-full text-white">
                <div class="p-2 text-indigo-400 rounded-full hover:bg-blue-50 cursor-pointer" @click="handleImageClick">
                ...
                <div class="p-2 text-indigo-400 rounded-full hover:bg-blue-50 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
            ...
            <div class="ml-auto">
                <UiButton size="sm" :disabled="isDisabled" @on-click="handleFormSubmit">Post</UiButton>
